...
* add convo memory, tracing & new metrics

### Features

* add convo memory, tracing & new metrics ([1975eb1](https://github.com/neverased/NeverBot/commit/1975eb14189f5215c199eae784ad43f912fdd5ae))
